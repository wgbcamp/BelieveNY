    ...
    return(
          <div className={styles.parentFont}>
            <div className={styles.centerDiv}>
              <div className={styles.titleBlockFlex}>
                ...
                <div className={styles.flexAlignItems}>
                  <div className={styles.everyone}></div>
                </div>
              </div>
            </div>
            <div className={styles.separator}></div>
              ...
              <div className={styles.outerCardFlex}>
              <div className={styles.cardFlex}>
                <div id="card1" className={styles.centerDiv}>
                  <div className={styles.subBlock}>
                    <div className={styles.servingFood}></div>
                ...
                <div id="card2" className={`${styles.centerDiv} ${styles.cardHeight}`}>
