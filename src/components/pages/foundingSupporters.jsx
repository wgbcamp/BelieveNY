        ...
        <div>
            <div className="simpleFlex whiten">
                <div className="maxWidth fSgrid padTop40">
                    ...
                    <div className="simpleFlex italicize lineHeight30 mb-5">
                        <ul className="no-bullets">
                            ...
                            <li>Naomi King</li>
                            <li>Joseph Lebers</li>
                            <li>Zachary Koshgarian</li>
                            <li>Sonny Curtin</li>
                            <li>Guy Aroch</li>
                            <li>Sasha Smith</li>
                            <li>Nia Combs</li>
                            <li>Brandon Haughton</li>
                            <li>Major Carr</li>
                            <li>Jasmine Dorothy Haefner</li>
                            <li>John Bulanchuk</li>
                            <li>K H</li>
                            <li>Markelle Smith</li>
                            <li>Audry Hiaoui</li>
                            <li>April R</li>
                            <li>Sara Espinal</li>
                            <li>Kyle Sorreta</li>
                            <li>Gerry Russo</li>
                            <li>Emma Morrison</li>
                            <li>Lindsey & Nic Millikan</li>
                            <li>Michael Guerin</li>
                            <li>Kathleen Lebers</li>
                        </ul>
                    </div>
                    </div>
                </div>
